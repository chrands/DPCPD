  ...
  return (
    <div>
      ...
      <section className="relative w-full h-[90vh] overflow-hidden flex items-center justify-center bg-deep">
        ...
        <div 
            className="absolute inset-0 w-full h-full bg-cover bg-center opacity-40 scale-105"
            style={{ 
        ...
        {/* Color Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-medical/20 to-deep/95 mix-blend-multiply" />
        <div className="absolute inset-0 bg-gradient-to-t from-deep via-transparent to-transparent" />

        {/* Hero Content */}
        <div className="relative z-10 text-center max-w-6xl px-6 pt-10">
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-full backdrop-blur-md mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-xl md:text-2xl text-white/90 font-light mb-10 max-w-4xl mx-auto leading-relaxed">
            三大内核形成<span className="text-medical font-medium mx-2">“病理精准”</span>飞轮效应
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16 text-left md:text-center">
             <div className="p-4 border-l-2 md:border-l-0 md:border-t-2 border-medical/50 bg-white/5 backdrop-blur-sm">
